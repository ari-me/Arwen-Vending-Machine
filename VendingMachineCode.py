...
items = {"1A": {"Dorito":6}, "2A":{"Cheetos":5}, "3A":{"Lays":5}, "1B": {"Twix":4}, "2B":{"Bueno":5}, "3B":{"M&Ms":3}, "1C": {"Cola":3}, "2C":{"Fanta":3}, "3C":{"Water":1}} #Item
...
while True: #A while loop to loop the program allowing the user to choose multiple products
    ...
    for key, value in items.items(): 
        for it in items[key]:
            it = it
            print(f"___________________________________\nID: {key} \t Item: {it} \tPrice: {items[key][it]}")
    ID = input("___________________________________\n\nSelect your item by entering the Item ID: ") #An input code to get the chosen item
